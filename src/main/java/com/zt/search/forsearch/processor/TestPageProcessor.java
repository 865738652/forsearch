...
import com.zt.search.forsearch.pipeline.ConsolePipeline;
...
public class TestPageProcessor implements PageProcessor {
    ...
    */
    ...
    public static void main(String[] args) {
        Spider.create(new TestPageProcessor()).addUrl("http://blog.sina.com.cn/s/articlelist_1487828712_0_1.html")
